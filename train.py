...
def greedy_decode(model, source, source_mask, tokenizer_src,tokenizer_tgt, max_len, device ):
    ...
    # precompute encoder output and use it for for every token we get from the decoader
    encoder_output = model.encode(source, source_mask)
    
    #initializing the decoder input with sos token
    ...
    while True:
        ...
        # select the token with the max probablity (greedy search)
